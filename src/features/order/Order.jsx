...
function Order() {
    ...
    // we can use the menu route without actually going there
    ...
    return (
      <div className="space-y-8 py-6 px-4">
        ...
        <u className="divide-y divide-stone-200 border-b border-t">
          {cart.map(item => 
            <OrderItem item={item} 
              key={item.pizzaId} 
...
// the laoder function gets automatically the params (which contains the id also)
